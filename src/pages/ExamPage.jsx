...
const ExamPage = () => {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      {time===0 ? "TimeOut" : setTime(prevTime => prevTime - 1)}
  ...
  return (
    <Container>
      <Row className="my-3 border border-black p-3 rounded">
        <Col>
        ...
        <Col className="d-flex ">
          <div className=''>
            <span className='mr-3'>{formatTime(time)}</span>
            <Button className='btn border border-black text-decoration-none m-auto text-white' variant="link" onClick={() => setTime(0)}>Hide</Button>
          </div>
        </Col>
        <div>
        ...
        <Col className="d-flex justify-content-end">
          <Button className='px-3 m-0' onClick={handleSaveAndExit}>Save & Exit</Button>
        </Col>
      </Row>

      {/* <hr className=''/> */}

      <Row className='flex border p-2 border-black rounded'>
        <Col md={8}>
          <p>{questions[currentQuestionIndex].question}</p>
        </Col>
        <Col md={4}>
          <div>
            <Button variant="link" className="mb-3 btn text-decoration-none bg-warning text-white border-0">Mark for Review</Button>
            <div>
            ...
            <Button variant="link" className='btn bg-danger text-white text-decoration-none'>Report Error</Button>
          </div>
        </Col>
      </Row>
      ...
      <Row className="my-3">
        <Col>
          <Button className='btn bg-black text-decoration-none text-white' variant="link" >
            DSAT Practice Test 1
          </Button>
        </Col>
        <Col className="d-flex justify-content-center">
          <Button variant="link" onClick={handlePopupShow} className='btn bg-secondary text-white text-decoration-none'>
